                ...
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="font-20 weight-500 mb-10">
                            Choisir l'année pour voir le stock
                        </h4>
                    </div>
                </div>
                <div>
                    <form action='/stocks/recherche' method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-7 col-sm-10 col-md-7">
                                <div class="form-group">
                                        <label class="label" for="stock">Année</label>
                                        <div class="select">
                                            <select id="stock" class="form-control" name="id_annee">
