                ...
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="font-20 weight-500 mb-10">
                            Choisir l'année et la catégorie pour voir l'ensemble des demandes
                        </h4>
                    </div>
                </div>
                <div>
                    <form action='/conso_categories/recherche' method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-7 col-sm-10 col-md-7">
                                ...
                                <div class="form-group">
                                    <label class="label" for="deman">Catégories</label>
                                    <div class="select">
                                        <select id="deman"
