    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                @endif
                <li class="dropdown">
                    <a href="{{route('provi.pdf')}}" class="dropdown-toggle no-arrow">
                        <span class="micon icon-copy dw dw-open-book-1"></span><span class="mtext">Pdf Appro</span>
                    </a>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="{{route('dem.pdf')}}" class="dropdown-toggle no-arrow">
                        <span class="micon icon-copy dw dw-open-book-1"></span><span class="mtext">Pdf Besoins</span>
                    </a>
                </li>
                <li class="dropdown">
